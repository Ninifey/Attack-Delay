...
public class LOTRModelDikDik extends ModelBase
{
    ...
    public LOTRModelDikDik() {
        (this.head = new ModelRenderer((ModelBase)this, 42, 23)).addBox(-2.0f, -9.0f, -3.0f, 4, 4, 5);
        ...
        (this.body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, 0.0f, 0.0f, 6, 6, 14);
        this.body.setRotationPoint(0.0f, 9.0f, -7.0f);
        (this.leg1 = new ModelRenderer((ModelBase)this, 56, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 10, 2);
        this.leg1.setRotationPoint(-1.7f, 14.0f, 5.0f);
        (this.leg2 = new ModelRenderer((ModelBase)this, 56, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 10, 2);
        this.leg2.setRotationPoint(1.7f, 14.0f, 5.0f);
        (this.leg3 = new ModelRenderer((ModelBase)this, 56, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 10, 2);
        this.leg3.setRotationPoint(-1.7f, 14.0f, -5.0f);
        (this.leg4 = new ModelRenderer((ModelBase)this, 56, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 10, 2);
