...
public class LOTRModelTrollTotem extends ModelBase
{
    ...
    public LOTRModelTrollTotem() {
        ...
        (this.head = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-6.0f, -10.0f, -10.0f, 12, 10, 12);
        ...
        (this.jaw = new ModelRenderer((ModelBase)this, 48, 0)).addBox(-6.0f, -2.0f, -6.0f, 12, 2, 12);
        this.jaw.setRotationPoint(0.0f, 24.0f, 0.0f);
        (this.body = new ModelRenderer((ModelBase)this, 0, 24)).addBox(-5.0f, 0.0f, -5.0f, 10, 16, 10);
        this.body.setRotationPoint(0.0f, 8.0f, 0.0f);
        (this.rightArm = new ModelRenderer((ModelBase)this, 40, 24)).addBox(-3.0f, 0.0f, -3.0f, 3, 10, 6);
        this.rightArm.setRotationPoint(-5.0f, 9.0f, 0.0f);
        this.leftArm = new ModelRenderer((ModelBase)this, 40, 24);
        this.leftArm.mirror = true;
        this.leftArm.addBox(0.0f, 0.0f, -3.0f, 3, 10, 6);
        this.leftArm.setRotationPoint(5.0f, 9.0f, 0.0f);
        (this.rightLeg = new ModelRenderer((ModelBase)this, 0, 50)).addBox(-3.0f, 0.0f, -3.0f, 6, 7, 6);
        this.rightLeg.setRotationPoint(-4.0f, 8.0f, 0.0f);
        this.rightLeg.setTextureOffset(24, 50).addBox(-2.5f, 7.0f, -2.5f, 5, 7, 5);
        this.leftLeg = new ModelRenderer((ModelBase)this, 0, 50);
        ...
        (this.base = new ModelRenderer((ModelBase)this, 48, 46)).addBox(-8.0f, 0.0f, -8.0f, 16, 2, 16);
        this.base.setRotationPoint(0.0f, 22.0f, 0.0f);
    }
    
    public void renderHead(final float f, final float f1) {
        this.head.rotateAngleX = f1 / 180.0f * 3.1415927f;
        this.head.render(f);
        this.jaw.render(f);
    }
    
    public void renderBody(final float f) {
        this.body.render(f);
        this.rightArm.render(f);
        this.leftArm.render(f);
    }
    
    public void renderBase(final float f) {
