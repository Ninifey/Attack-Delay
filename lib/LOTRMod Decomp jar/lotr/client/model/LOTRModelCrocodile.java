...
public class LOTRModelCrocodile extends ModelBase
{
    ...
    public LOTRModelCrocodile() {
        (this.body = new ModelRenderer((ModelBase)this, 18, 83).setTextureSize(128, 128)).addBox(-8.0f, -5.0f, 0.0f, 16, 9, 36);
        this.body.setRotationPoint(0.0f, 17.0f, -16.0f);
        (this.tail1 = new ModelRenderer((ModelBase)this, 0, 28).setTextureSize(128, 128)).addBox(-7.0f, 0.0f, 0.0f, 14, 7, 19);
        this.tail1.setRotationPoint(0.0f, 13.0f, 18.0f);
        (this.tail2 = new ModelRenderer((ModelBase)this, 0, 55).setTextureSize(128, 128)).addBox(-6.0f, 1.5f, 17.0f, 12, 5, 16);
        this.tail2.setRotationPoint(0.0f, 13.0f, 18.0f);
        (this.tail3 = new ModelRenderer((ModelBase)this, 0, 77).setTextureSize(128, 128)).addBox(-5.0f, 3.0f, 31.0f, 10, 3, 14);
        this.tail3.setRotationPoint(0.0f, 13.0f, 18.0f);
        (this.jaw = new ModelRenderer((ModelBase)this, 58, 18).setTextureSize(128, 128)).addBox(-6.5f, 0.3f, -19.0f, 13, 4, 19);
        this.jaw.setRotationPoint(0.0f, 17.0f, -16.0f);
        (this.head = new ModelRenderer((ModelBase)this, 0, 0).setTextureSize(128, 128)).addBox(-7.5f, -6.0f, -21.0f, 15, 6, 21);
        this.head.setRotationPoint(0.0f, 18.5f, -16.0f);
        (this.legFrontLeft = new ModelRenderer((ModelBase)this, 2, 104).setTextureSize(128, 128)).addBox(0.0f, 0.0f, -3.0f, 16, 3, 6);
        this.legFrontLeft.setRotationPoint(6.0f, 15.0f, -11.0f);
        (this.legBackLeft = new ModelRenderer((ModelBase)this, 2, 104).setTextureSize(128, 128)).addBox(0.0f, 0.0f, -3.0f, 16, 3, 6);
        this.legBackLeft.setRotationPoint(6.0f, 15.0f, 15.0f);
        this.legFrontRight = new ModelRenderer((ModelBase)this, 2, 104).setTextureSize(128, 128);
        ...
        this.legBackRight = new ModelRenderer((ModelBase)this, 2, 104).setTextureSize(128, 128);
        ...
        (this.spines = new ModelRenderer((ModelBase)this, 46, 45).setTextureSize(128, 128)).addBox(-5.0f, 0.0f, 0.0f, 10, 4, 32);
