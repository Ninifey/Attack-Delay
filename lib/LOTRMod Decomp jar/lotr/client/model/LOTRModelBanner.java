...
public class LOTRModelBanner extends ModelBase
{
    ...
    public LOTRModelBanner() {
        ...
        (this.post = new ModelRenderer((ModelBase)this, 0, 14)).setRotationPoint(0.0f, 24.0f, 0.0f);
        this.post.addBox(-0.5f, -48.0f, -0.5f, 1, 47, 1);
        this.post.setTextureOffset(4, 14).addBox(-8.0f, -43.0f, -1.5f, 16, 1, 3);
        (this.lowerPost = new ModelRenderer((ModelBase)this, 0, 14)).setRotationPoint(0.0f, 24.0f, 0.0f);
        this.lowerPost.addBox(-0.5f, -1.0f, -0.5f, 1, 24, 1);
        (this.bannerFront = new ModelRenderer((ModelBase)this, 0, 0)).setRotationPoint(0.0f, -18.0f, 0.0f);
        this.bannerFront.addBox(-8.0f, 0.0f, -1.0f, 16, 32, 0);
        (this.bannerBack = new ModelRenderer((ModelBase)this, 0, 0)).setRotationPoint(0.0f, -18.0f, 0.0f);
        this.bannerBack.addBox(-8.0f, 0.0f, -1.0f, 16, 32, 0);
        this.bannerBack.rotateAngleY = 3.1415927f;
    }
    
    public void renderStand(final float f) {
        this.stand.render(f);
    }
    ...
    public void renderLowerPost(final float f) {
