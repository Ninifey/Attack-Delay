...
public class LOTRModelLion extends ModelBase
{
    ...
    public LOTRModelLion() {
        ...
        (this.head = new ModelRenderer((ModelBase)this, 48, 0)).setRotationPoint(0.0f, 3.0f, -10.0f);
        ...
        (this.mane = new ModelRenderer((ModelBase)this, 0, 0)).setRotationPoint(0.0f, 3.0f, -10.0f);
        this.mane.addBox(-8.0f, -10.0f, -6.0f, 16, 16, 8);
        (this.body = new ModelRenderer((ModelBase)this, 0, 24)).setRotationPoint(0.0f, 6.0f, 1.0f);
        this.body.addBox(-7.0f, -6.5f, -11.0f, 14, 14, 24);
        (this.leg1 = new ModelRenderer((ModelBase)this, 52, 24)).setRotationPoint(-4.0f, 4.0f, 11.0f);
        this.leg1.addBox(-6.0f, -2.0f, -3.5f, 6, 10, 8);
        this.leg1.setTextureOffset(106, 24).addBox(-5.5f, 8.0f, -2.5f, 5, 12, 5);
        (this.leg2 = new ModelRenderer((ModelBase)this, 52, 24)).setRotationPoint(4.0f, 4.0f, 11.0f);
        this.leg2.mirror = true;
        this.leg2.addBox(0.0f, -2.0f, -3.5f, 6, 10, 8);
        this.leg2.setTextureOffset(106, 24).addBox(0.5f, 8.0f, -2.5f, 5, 12, 5);
        (this.leg3 = new ModelRenderer((ModelBase)this, 80, 24)).setRotationPoint(-4.0f, 5.0f, -5.0f);
        this.leg3.addBox(-6.0f, -2.0f, -3.5f, 6, 9, 7);
        this.leg3.setTextureOffset(106, 24).addBox(-5.5f, 7.0f, -2.5f, 5, 12, 5);
        (this.leg4 = new ModelRenderer((ModelBase)this, 80, 24)).setRotationPoint(4.0f, 5.0f, -5.0f);
        this.leg4.mirror = true;
        this.leg4.addBox(0.0f, -2.0f, -3.5f, 6, 9, 7);
        this.leg4.setTextureOffset(106, 24).addBox(0.5f, 7.0f, -2.5f, 5, 12, 5);
        (this.tail = new ModelRenderer((ModelBase)this, 100, 50)).setRotationPoint(0.0f, 4.0f, 13.0f);
