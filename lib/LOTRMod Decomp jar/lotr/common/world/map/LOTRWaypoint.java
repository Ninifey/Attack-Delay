...
public enum LOTRWaypoint implements LOTRAbstractWaypoint
{
    ...
    private LOTRWaypoint(final Region r, final LOTRFaction f, final int x, final int y) {
        this(r, f, x, y, false);
    }
    
    private LOTRWaypoint(final Region r, final LOTRFaction f, final int x, final int y, final boolean hide) {
        this.region = r;
    ...
    public static LOTRWaypoint waypointForName(final String name) {
        for (final LOTRWaypoint wp : values()) {
    ...
    public static List<LOTRAbstractWaypoint> listAllWaypoints() {
        final List<LOTRAbstractWaypoint> list = new ArrayList<LOTRAbstractWaypoint>();
        list.addAll(Arrays.asList(values()));
        return list;
    }
    
    public static Region regionForName(final String name) {
    ...
    public static Region regionForID(final int id) {
        for (final Region region : Region.values()) {
    ...
    public enum Region
    {
        ...
        private Region() {
            this.waypoints = new ArrayList<LOTRWaypoint>();
        }
    }
}
