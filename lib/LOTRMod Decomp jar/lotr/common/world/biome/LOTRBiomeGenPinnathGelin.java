...
public class LOTRBiomeGenPinnathGelin extends LOTRBiomeGenGondor
{
    ...
    public LOTRBiomeGenPinnathGelin(final int i, final boolean major) {
        super(i, major);
        ...
        lists[n] = LOTRBiomeSpawnList.entry(LOTRSpawnList.PINNATH_GELIN_SOLDIERS, 10).setSpawnChance(100);
        ...
        lists2[n2] = LOTRBiomeSpawnList.entry(LOTRSpawnList.PINNATH_GELIN_SOLDIERS, 10);
        ...
        super.decorator.setTreeCluster(6, 80);
        ...
        super.decorator.addTree(LOTRTreeType.ASPEN, 500);
        ...
        super.biomeColors.setGrass(10930470);
        this.setBanditChance(LOTREventSpawner.EventChance.BANDIT_RARE);
    }
    
    @Override
    protected void addFiefdomStructures() {
        super.decorator.addRandomStructure(new LOTRWorldGenPinnathGelinWatchfort(false), 1000);
        super.decorator.addVillage(new LOTRVillageGenGondor(this, LOTRWorldGenGondorStructure.GondorFiefdom.PINNATH_GELIN, 0.5f));
    }
