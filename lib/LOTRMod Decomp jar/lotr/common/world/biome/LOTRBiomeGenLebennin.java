...
public class LOTRBiomeGenLebennin extends LOTRBiomeGenGondor
{
    ...
    public LOTRBiomeGenLebennin(final int i, final boolean major) {
        super(i, major);
        ...
        lists[n] = LOTRBiomeSpawnList.entry(LOTRSpawnList.LEBENNIN_SOLDIERS, 10).setSpawnChance(100);
        ...
        lists2[n2] = LOTRBiomeSpawnList.entry(LOTRSpawnList.LEBENNIN_SOLDIERS, 10);
        ...
        final LOTRBiomeSpawnList.SpawnListContainer[] lists5 = new LOTRBiomeSpawnList.SpawnListContainer[7];
        final int n10 = 0;
        ...
        lists5[n14] = LOTRBiomeSpawnList.entry(LOTRSpawnList.UMBARIANS, 2).setConquestThreshold(100.0f);
        final int n15 = 5;
        final LOTRBiomeSpawnList npcSpawnList15 = super.npcSpawnList;
        lists5[n15] = LOTRBiomeSpawnList.entry(LOTRSpawnList.UMBAR_SOLDIERS, 10);
        final int n16 = 6;
        final LOTRBiomeSpawnList npcSpawnList16 = super.npcSpawnList;
        lists5[n16] = LOTRBiomeSpawnList.entry(LOTRSpawnList.CORSAIRS, 20);
        ...
        super.decorator.addTree(LOTRTreeType.BEECH, 150);
    ...
    protected void addFiefdomStructures() {
        super.decorator.addRandomStructure(new LOTRWorldGenLebenninWatchfort(false), 800);
        super.decorator.addVillage(new LOTRVillageGenGondor(this, LOTRWorldGenGondorStructure.GondorFiefdom.LEBENNIN, 0.75f));
    }
