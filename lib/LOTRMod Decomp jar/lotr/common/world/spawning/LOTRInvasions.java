...
public enum LOTRInvasions
{
    ...
    public List<InvasionSpawnEntry> invasionMobs;
    private Item invasionIcon;
    
    private LOTRInvasions(final LOTRFaction f) {
        this(f, null);
    }
    
    private LOTRInvasions(final LOTRFaction f, final String s) {
        this.invasionMobs = new ArrayList<InvasionSpawnEntry>();
    ...
    public final ItemStack createConquestHorn() {
        final ItemStack horn = new ItemStack(LOTRMod.conquestHorn);
    ...
    public static LOTRInvasions forName(final String name) {
        for (final LOTRInvasions i : values()) {
    ...
    public static LOTRInvasions forID(final int ID) {
        for (final LOTRInvasions i : values()) {
            if (i.ordinal() == ID) {
                return i;
            }
    ...
    public static class InvasionSpawnEntry extends WeightedRandom.Item
    {
        ...
        public InvasionSpawnEntry(final Class<? extends LOTREntityNPC> c, final int chance) {
            super(chance);
            this.entityClass = c;
        }
