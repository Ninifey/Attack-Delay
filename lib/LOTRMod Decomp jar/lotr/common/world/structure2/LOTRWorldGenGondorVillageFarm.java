...
{
    public LOTRWorldGenGondorVillageFarm(final boolean flag) {
        super(flag);
    }
        ...
        for (int i5 = -5; i5 <= 5; ++i5) {
            for (int k5 = -5; k5 <= 5; ++k5) {
                ...
                for (int j2 = 0; (j2 >= 0 || !this.isOpaque(world, i5, j2, k5)) && this.getY(j2) >= 0; --j2) {
                    this.setBlockAndMetadata(world, i5, j2, k5, super.rockBlock, super.rockMeta);
                ...
                if (i6 == 5 && k6 == 5) {
                    this.setBlockAndMetadata(world, i5, 1, k5, super.rockBlock, super.rockMeta);
                    this.setBlockAndMetadata(world, i5, 2, k5, super.rockSlabBlock, super.rockSlabMeta);
                }
                else if (i6 == 5 || k6 == 5) {
                    this.setBlockAndMetadata(world, i5, 1, k5, super.rockWallBlock, super.rockWallMeta);
                    if (i6 == 3 || k6 == 3) {
                        this.setBlockAndMetadata(world, i5, 2, k5, Blocks.torch, 5);
                    }
                    if (i6 == 0 || k6 == 0) {
                ...
                for (int k2 = -4; k2 <= 4; ++k2) {
                    ...
                    if (i3 <= 2 && k3 <= 2) {
                        if (i3 == 0 && k3 == 0) {
                            ...
                            this.setBlockAndMetadata(world, i2, 1, k2, super.rockBlock, super.rockMeta);
        ...
        public boolean generateWithSetRotation(final World world, final Random random, final int i, final int j, final int k, final int rotation) {
            ...
            for (int i2 = -5; i2 <= 5; ++i2) {
                for (int k2 = -5; k2 <= 5; ++k2) {
                    ...
                    final int k3 = Math.abs(k2);
                    if (i3 == 5 && k3 == 5) {
                        this.setBlockAndMetadata(world, i2, 2, k2, super.rockWallBlock, super.rockWallMeta);
                        this.setBlockAndMetadata(world, i2, 3, k2, (Block)Blocks.leaves, 4);
                    }
                }
            }
            for (int l = 0; l < 16; ++l) {
