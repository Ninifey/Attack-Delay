...
public abstract class LOTRWorldGenGondorStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenGondorStructure(final boolean flag) {
        super(flag);
        this.strFief = GondorFiefdom.GONDOR;
    }
    ...
    protected void setupRandomBlocks(final Random random) {
        ...
        if (this.strFief == GondorFiefdom.GONDOR || this.strFief == GondorFiefdom.BLACKROOT_VALE) {
            ...
            this.brick2Meta = 0;
            this.brick2SlabBlock = (Block)Blocks.stone_slab;
            this.brick2SlabMeta = 3;
        ...
        this.cobbleMeta = 0;
        this.cobbleSlabBlock = (Block)Blocks.stone_slab;
        ...
        if (this.strFief == GondorFiefdom.BLACKROOT_VALE) {
            ...
            final int randomWood = random.nextInt(7);
        ...
        if (this.strFief == GondorFiefdom.PINNATH_GELIN || this.strFief == GondorFiefdom.LOSSARNACH || this.strFief == GondorFiefdom.LAMEDON) {
        ...
        if (this.strFief == GondorFiefdom.LOSSARNACH || this.strFief == GondorFiefdom.LAMEDON || this.strFief == GondorFiefdom.BLACKROOT_VALE) {
            if (random.nextBoolean()) {
        ...
        if (this.strFief == GondorFiefdom.PELARGIR) {
    ...
    public enum GondorFiefdom
    {
        ...
        public LOTREntityGondorMan createCaptain(final World world) {
            if (this == GondorFiefdom.GONDOR) {
                return new LOTREntityGondorianCaptain(world);
            }
            if (this == GondorFiefdom.LOSSARNACH) {
                return new LOTREntityLossarnachCaptain(world);
            }
            if (this == GondorFiefdom.LEBENNIN) {
                return new LOTREntityLebenninCaptain(world);
            }
            if (this == GondorFiefdom.PELARGIR) {
                return new LOTREntityPelargirCaptain(world);
            }
            if (this == GondorFiefdom.PINNATH_GELIN) {
                return new LOTREntityPinnathGelinCaptain(world);
            }
            if (this == GondorFiefdom.BLACKROOT_VALE) {
                return new LOTREntityBlackrootCaptain(world);
            }
            if (this == GondorFiefdom.LAMEDON) {
                return new LOTREntityLamedonCaptain(world);
            }
            if (this == GondorFiefdom.DOL_AMROTH) {
