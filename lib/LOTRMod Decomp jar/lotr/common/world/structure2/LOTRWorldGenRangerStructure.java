...
public abstract class LOTRWorldGenRangerStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenRangerStructure(final boolean flag) {
        super(flag);
    }
