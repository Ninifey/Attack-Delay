...
public class LOTRWorldGenRohanVillageSign extends LOTRWorldGenRohanStructure
{
    ...
    public LOTRWorldGenRohanVillageSign(final boolean flag) {
        super(flag);
        this.signText = LOTRNames.getRohanVillageName(new Random());
    }
    
    public LOTRWorldGenRohanVillageSign setSignText(final String[] s) {
        this.signText = s;
        return this;
    }
    ...
    public boolean generateWithSetRotation(final World world, final Random random, final int i, final int j, final int k, final int rotation) {
        ...
        for (int j3 = 0; (j3 >= 0 || !this.isOpaque(world, 0, j3, 0)) && this.getY(j3) >= 0; --j3) {
            this.setBlockAndMetadata(world, 0, j3, 0, super.woodBeamRohanBlock, super.woodBeamRohanMeta);
            this.setGrassToDirt(world, 0, j3 - 1, 0);
        }
        this.setBlockAndMetadata(world, 0, 1, 0, super.woodBeamRohanBlock, super.woodBeamRohanMeta);
        this.setBlockAndMetadata(world, 0, 2, 0, super.woodBeamRohanBlock, super.woodBeamRohanMeta);
        this.setBlockAndMetadata(world, 0, 3, 0, super.woodBeamRohanBlock, super.woodBeamRohanMeta);
