...
public abstract class LOTRWorldGenSouthronStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenSouthronStructure(final boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(final Random random) {
        ...
        this.woodBeamMeta4 = (this.woodBeamMeta | 0x4);
        this.woodBeamMeta8 = (this.woodBeamMeta | 0x8);
        ...
        if (random.nextBoolean()) {
            ...
            final int randomCrop = random.nextInt(3);
            if (randomCrop == 0) {
        ...
        if (this.isUmbar()) {
            ...
            this.pillarBlock = LOTRMod.pillar;
            this.pillarMeta = 9;
            final int randomRoof = random.nextInt(4);
            if (randomRoof == 0) {
            ...
            this.woodBeamMeta4 = this.woodBeamMeta;
    ...
    protected LOTREntityNearHaradrimBase createHaradrim(final World world) {
        if (this.isUmbar()) {
    ...
    protected ItemStack getRandomHaradWeapon(final Random random) {
    ...
    protected ItemStack getRandomHaradItem(final Random random) {
