...
public abstract class LOTRWorldGenRohanStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenRohanStructure(final boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(final Random random) {
        ...
        final int randomWood = random.nextInt(6);
        ...
        final int randomWood2 = random.nextInt(4);
    ...
    protected ItemStack getRandomRohanWeapon(final Random random) {
        final ItemStack[] items = { new ItemStack(LOTRMod.swordRohan), new ItemStack(LOTRMod.battleaxeRohan), new ItemStack(LOTRMod.daggerRohan), new ItemStack(LOTRMod.spearRohan) };
        return items[random.nextInt(items.length)].copy();
    }
    ...
    protected Block getRandomCakeBlock(final Random random) {
