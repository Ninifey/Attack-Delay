...
public abstract class LOTRWorldGenGulfStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenGulfStructure(final boolean flag) {
        super(flag);
    }
    ...
    protected ItemStack getRandomGulfWeapon(final Random random) {
        final ItemStack[] items = { new ItemStack(LOTRMod.swordGulfHarad), new ItemStack(LOTRMod.swordGulfHarad), new ItemStack(LOTRMod.daggerHarad), new ItemStack(LOTRMod.spearHarad), new ItemStack(LOTRMod.pikeHarad) };
