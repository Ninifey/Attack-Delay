...
public abstract class LOTRWorldGenHobbitStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenHobbitStructure(final boolean flag) {
        super(flag);
    }
    ...
    protected void setupRandomBlocks(final Random random) {
        ...
        final int randomWood = random.nextInt(5);
        if (randomWood == 0) {
        ...
        if (this.isWealthy) {
            final int randomWood2 = random.nextInt(3);
            if (randomWood2 == 0) {
            ...
            if (randomWood2 == 0) {
                ...
                this.plank2Meta = 0;
                this.plank2SlabBlock = (Block)Blocks.wooden_slab;
        ...
        final int randomCarpet = random.nextInt(5);
        if (randomCarpet == 0) {
        ...
        if (this.isWealthy) {
            final int randomChandelier = random.nextInt(2);
        ...
        this.hedgeBlock = (Block)Blocks.leaves;
        this.hedgeMeta = 4;
        if (random.nextBoolean()) {
        ...
        final int randomGate = random.nextInt(4);
        if (randomGate == 0) {
        ...
        final String[] hobbitNames = LOTRNames.getHobbitCoupleAndHomeNames(random);
    ...
    protected void spawnHobbitCouple(final World world, final int i, final int j, final int k, final int homeRange) {
        final LOTREntityHobbit hobbitMale = new LOTREntityHobbit(world);
        ...
        final LOTREntityHobbit hobbitFemale = new LOTREntityHobbit(world);
        ...
        final int maxChildren = hobbitMale.familyInfo.getRandomMaxChildren();
    ...
    public static Block getRandomCakeBlock(final Random random) {
