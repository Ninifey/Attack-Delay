...
{
    public LOTRWorldGenEasterlingWell(final boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(final World world, final Random random, final int i, final int j, final int k, final int rotation) {
        ...
        for (int i2 = -2; i2 <= 2; ++i2) {
            for (int k2 = -2; k2 <= 2; ++k2) {
                ...
                if (i3 == 1 && k3 == 1) {
                    this.setBlockAndMetadata(world, i2, 1, k2, super.logBlock, super.logMeta);
                    for (int j3 = 2; j3 <= 3; ++j3) {
                        this.setBlockAndMetadata(world, i2, j3, k2, super.fenceBlock, super.fenceMeta);
                    }
                    this.setBlockAndMetadata(world, i2, 4, k2, super.plankSlabBlock, super.plankSlabMeta);
                }
        ...
        for (wellTop = -1, wellBottom = (j3 = wellTop - depth - waterDepth - 1); j3 <= wellTop; ++j3) {
            for (int i4 = -1; i4 <= 1; ++i4) {
                for (int k4 = -1; k4 <= 1; ++k4) {
                    ...
                    if (j3 == wellBottom) {
                        this.setBlockAndMetadata(world, i4, j3, k4, LOTRMod.dirtPath, 0);
                    }
                    else if (i5 == 0 && k5 == 0) {
