...
public abstract class LOTRWorldGenDunlandStructure extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenDunlandStructure(final boolean flag) {
        super(flag);
    }
    ...
    protected ItemStack getRandomDunlandWeapon(final Random random) {
        final ItemStack[] items = { new ItemStack(Items.iron_sword), new ItemStack(LOTRMod.spearIron), new ItemStack(LOTRMod.daggerIron), new ItemStack(Items.stone_sword), new ItemStack(LOTRMod.spearStone), new ItemStack(LOTRMod.dunlendingClub), new ItemStack(LOTRMod.dunlendingTrident) };
        return items[random.nextInt(items.length)].copy();
    }
    
    protected void placeDunlandItemFrame(final World world, final Random random, final int i, final int j, final int k, final int direction) {
        final ItemStack[] items = { new ItemStack(Items.bone), new ItemStack(LOTRMod.fur), new ItemStack(Items.flint), new ItemStack(Items.iron_sword), new ItemStack(Items.stone_sword), new ItemStack(LOTRMod.spearIron), new ItemStack(LOTRMod.spearStone), new ItemStack((Item)Items.bow), new ItemStack(Items.arrow), new ItemStack(LOTRMod.mug), new ItemStack(LOTRMod.skullCup) };
        final ItemStack item = items[random.nextInt(items.length)].copy();
