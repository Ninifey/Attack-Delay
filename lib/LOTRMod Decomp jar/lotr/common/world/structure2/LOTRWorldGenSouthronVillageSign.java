...
public class LOTRWorldGenSouthronVillageSign extends LOTRWorldGenSouthronStructure
{
    ...
    public LOTRWorldGenSouthronVillageSign(final boolean flag) {
        super(flag);
        this.signText = LOTRNames.getHaradVillageName(new Random());
    }
    
    public LOTRWorldGenSouthronVillageSign setSignText(final String[] s) {
        this.signText = s;
        return this;
    }
    ...
    public boolean generateWithSetRotation(final World world, final Random random, final int i, final int j, final int k, final int rotation) {
        ...
        this.setBlockAndMetadata(world, 0, 4, 0, super.brickSlabBlock, super.brickSlabMeta);
