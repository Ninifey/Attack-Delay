...
public class LOTRWorldGenMoredainMercTent extends LOTRWorldGenStructureBase2
{
    ...
    public LOTRWorldGenMoredainMercTent(final boolean flag) {
        super(flag);
    }
    ...
    public boolean generateWithSetRotation(final World world, final Random random, final int i, final int j, final int k, final int rotation) {
        ...
        for (int k3 = -3; k3 <= 3; ++k3) {
            final boolean tent2 = IntMath.mod(k3, 2) == 0;
            final Block block = tent2 ? this.tent2Block : this.tentBlock;
            final int meta = tent2 ? this.tent2Meta : this.tentMeta;
            ...
            this.setBlockAndMetadata(world, -1, 3, k3, block, meta);
            this.setBlockAndMetadata(world, 1, 3, k3, block, meta);
            this.setBlockAndMetadata(world, 0, 4, k3, block, meta);
            if (Math.abs(k3) == 3) {
                this.setBlockAndMetadata(world, 0, 5, k3, block, meta);
            }
        }
