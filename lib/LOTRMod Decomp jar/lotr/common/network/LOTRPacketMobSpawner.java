...
public class LOTRPacketMobSpawner implements IMessage
{
    ...
    public LOTRPacketMobSpawner(final int x, final int y, final int z, final int dim) {
        this.xCoord = x;
        this.yCoord = y;
        this.zCoord = z;
        this.dimension = dim;
    ...
    {
        public IMessage onMessage(final LOTRPacketMobSpawner packet, final MessageContext context) {
            final World world = (World)DimensionManager.getWorld(packet.dimension);
            if (world != null) {
                final int i = packet.xCoord;
                final int j = packet.yCoord;
                ...
                if (tileentity instanceof LOTRTileEntityMobSpawner) {
                    ...
                    mobSpawner.delay = -1;
                    world.func_147452_c(i, j, k, mobSpawner.getBlockType(), 2, 0);
                }
            }
            return null;
        }
