...
public enum LOTRShields
{
    ...
    HARAD_CONTEST(new String[] { "05d987d8-7e3d-44b2-a170-234efe19f907", "d4ff096b-a38c-47c6-8cec-2bf336affb6d", "2c862690-b9d4-42de-a1b9-cb2200b75e72" }), 
    RHUN_CONTEST(new String[] { "e69ddad2-db7a-48c5-aefe-20cc196d6ac0", "6b18abb7-5533-4ae3-908e-18a7f44a2092", "45255b67-6bfd-434c-8fed-e1f56e18da6a" }), 
    ...
    LOREMASTER_2014(new String[] { "cad6e5c7-5362-46fc-ac46-0b5f2eb18f97", "f1e02905-1659-468c-b80f-6301e13384ab", "519ad9d7-3a47-45e2-9933-0c416cd60553", "c674a50d-9dcb-464d-af43-a4c7c0af411b", "bd8086bf-80c5-4c93-ac1a-269e4beb59bd", "f2b2a972-7bec-412d-9a5b-e616877eca23", "24fbd7cf-bd84-4ea5-94b8-0cf96e44126e", "279083d4-03d7-4b2c-954d-eab49ed99492", "cf5519e2-1d45-4762-bc38-605de9ed5a07", "a166423a-a1e3-45b1-a4b8-dea69f2bd64e" }), 
    LOREMASTER_2015(new String[] { "24fbd7cf-bd84-4ea5-94b8-0cf96e44126e", "7bc56da6-f133-4e47-8d0f-a2776762bca6", "519ad9d7-3a47-45e2-9933-0c416cd60553", "279083d4-03d7-4b2c-954d-eab49ed99492", "cf5519e2-1d45-4762-bc38-605de9ed5a07", "da3c4298-17ff-4310-a20b-9523678bd5ef", "37b3bac5-96e5-463d-9a21-a2a398871ff1", "bd8086bf-80c5-4c93-ac1a-269e4beb59bd", "c674a50d-9dcb-464d-af43-a4c7c0af411b", "985940be-7bd8-4f7c-b05d-dd06bae2e2b9" }), 
    LOREMASTER_2016(new String[] { "3b1bcb28-084e-4c8e-8687-924912feedb2", "24fbd7cf-bd84-4ea5-94b8-0cf96e44126e", "c674a50d-9dcb-464d-af43-a4c7c0af411b", "bd8086bf-80c5-4c93-ac1a-269e4beb59bd", "9d8b2b0b-43c4-4abd-9d07-eee7e4dc2d19", "9793f61c-5bc7-479d-be11-1b122d4a249f", "10bb7b50-f974-4848-af88-23ee0319e3a4", "7bc56da6-f133-4e47-8d0f-a2776762bca6", "68360a81-5450-4ff9-8430-ec0243496d55", "543195a2-5616-446d-9376-0b7fd3647ab1" });
    ...
    private LOTRShields(final LOTRFaction faction) {
    ...
    private LOTRShields(final String[] players) {
        this(false, players);
    }
    
    private LOTRShields(final boolean hidden, final String[] players) {
        this(ShieldType.EXCLUSIVE, hidden, players);
    }
    
    private LOTRShields(final ShieldType type, final boolean hidden, final String[] players) {
    ...
    public boolean canPlayerWear(final EntityPlayer entityplayer) {
        ...
        if (this.shieldType == ShieldType.EXCLUSIVE) {
            for (final UUID uuid : this.exclusiveUUIDs) {
    ...
    public static LOTRShields shieldForName(final String shieldName) {
        for (final LOTRShields shield : values()) {
    ...
    public enum ShieldType
    {
        ...
        public List<LOTRShields> list;
        
        private ShieldType() {
            this.list = new ArrayList<LOTRShields>();
        }
