...
public class LOTRItemMysteryWeb extends Item
{
    public LOTRItemMysteryWeb() {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject((Object)this, (Object)new LOTRDispenseMysteryWeb());
    }
    ...
    public ItemStack onItemRightClick(final ItemStack itemstack, final World world, final EntityPlayer entityplayer) {
        ...
        if (!world.isClient) {
            world.spawnEntityInWorld((Entity)new LOTREntityMysteryWeb(world, (EntityLivingBase)entityplayer));
        }
        return itemstack;
    }
}
