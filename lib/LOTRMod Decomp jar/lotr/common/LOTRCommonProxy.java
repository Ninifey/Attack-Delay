...
public class LOTRCommonProxy implements IGuiHandler
{
    ...
    public Object getServerGuiElement(final int ID, final EntityPlayer entityplayer, final World world, final int i, final int j, final int k) {
        if (ID == 0) {
            final TileEntity oven = world.getTileEntity(i, j, k);
        ...
        if (ID == 3) {
            final Entity entity = world.getEntityByID(i);
        ...
        if (ID == 5) {
            final TileEntity forge = world.getTileEntity(i, j, k);
            if (forge instanceof LOTRTileEntityAlloyForgeBase) {
        ...
        if (ID == 15 && entityplayer.inventory.getCurrentItem() != null && entityplayer.inventory.getCurrentItem().getItem() == LOTRMod.pouch) {
            return new LOTRContainerPouch(entityplayer);
        }
        if (ID == 16) {
            final TileEntity barrel = world.getTileEntity(i, j, k);
        ...
        if (ID == 17) {
            final TileEntity stand = world.getTileEntity(i, j, k);
        ...
        if (ID == 29) {
            ...
            if (entity instanceof LOTREntityNPCRideable) {
                final LOTREntityNPCRideable npc2 = (LOTREntityNPCRideable)entity;
                if (npc2.getMountInventory() != null) {
                    return new LOTRContainerNPCMountInventory((IInventory)entityplayer.inventory, npc2.getMountInventory(), npc2);
                }
            }
        }
        if (ID == 30) {
        ...
        if (ID == 38) {
            final TileEntity unsmeltery = world.getTileEntity(i, j, k);
            if (unsmeltery instanceof LOTRTileEntityUnsmeltery) {
        ...
        if (ID == 40) {
            final TileEntity trap = world.getTileEntity(i, j, k);
            if (trap instanceof LOTRTileEntityDartTrap) {
                return new ContainerDispenser((IInventory)entityplayer.inventory, (TileEntityDispenser)trap);
            }
        }
        if (ID == 41) {
            final TileEntity chest = world.getTileEntity(i, j, k);
            if (chest instanceof LOTRTileEntityChest) {
                return new ContainerChest((IInventory)entityplayer.inventory, (IInventory)chest);
            }
        }
        if (ID == 42) {
        ...
        if (ID == 50) {
            final TileEntity beacon = world.getTileEntity(i, j, k);
            if (beacon instanceof LOTRTileEntityBeacon) {
        ...
        if (ID == 52) {
            final TileEntity millstone = world.getTileEntity(i, j, k);
            if (millstone instanceof LOTRTileEntityMillstone) {
        ...
        if (ID == 55) {
            final TileEntity bookshelf = world.getTileEntity(i, j, k);
    ...
    public Object getClientGuiElement(final int ID, final EntityPlayer entityplayer, final World world, final int i, final int j, final int k) {
        ...
        if (ID == 41) {
            final TileEntity chest = world.getTileEntity(i, j, k);
            if (chest instanceof LOTRTileEntityChest) {
                return new GuiChest((IInventory)entityplayer.inventory, (IInventory)chest);
            }
        }
        if (ID == 42) {
        ...
        if (ID == 47) {
            ...
            final LOTRTileEntitySign fake = (LOTRTileEntitySign)block.createTileEntity(world, meta);
    ...
    public void fillMugFromCauldron(final World world, final int i, final int j, final int k, final int side, final ItemStack itemstack) {
        world.setBlockMetadata(i, j, k, world.getBlockMetadata(i, j, k) - 1, 3);
    }
