...
{
    public LOTREntityTauredain(final World world) {
        super(world);
        ...
        ((EntityLiving)this).tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.TAUREDAIN, 8000));
        ((EntityLiving)this).tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.TAUREDAIN_DRINK, 8000));
    ...
    public String getNPCFormattedName(final String npcName, final String entityName) {
        if (this.getClass() == LOTREntityTauredain.class) {
            return StatCollector.translateToLocalFormatted("entity.lotr.Tauredain.entityName", new Object[] { npcName });
        }
