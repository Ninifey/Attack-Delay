...
{
    public LOTREntityHarnedorBartender(final World world) {
        super(world);
        this.addTargetTasks(false);
        super.npcLocationName = "entity.lotr.HarnedorBartender.locationName";
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        super.npcItemsInv.setIdleItem(new ItemStack(LOTRMod.gobletWood));
        return data;
    }
    ...
    public void dropFewItems(final boolean flag, final int i) {
        ...
        for (int drinks = 1 + ((Entity)this).rand.nextInt(4) + i, l = 0; l < drinks; ++l) {
            final ItemStack drink = LOTRFoods.HARNEDOR_DRINK.getRandomFood(((Entity)this).rand);
