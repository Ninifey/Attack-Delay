...
{
    public LOTREntitySouthronBartender(final World world) {
        super(world);
        this.addTargetTasks(false);
        super.npcLocationName = "entity.lotr.SouthronBartender.locationName";
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        super.npcItemsInv.setIdleItem(new ItemStack(LOTRMod.gobletCopper));
        return data;
    }
