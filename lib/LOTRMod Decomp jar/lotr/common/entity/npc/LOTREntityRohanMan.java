...
public class LOTREntityRohanMan extends LOTREntityMan
{
    ...
    public LOTREntityRohanMan(final World world) {
        super(world);
        ...
        ((EntityLiving)this).tasks.addTask(2, this.createRohanAttackAI());
        ...
        ((EntityLiving)this).tasks.addTask(6, (EntityAIBase)new LOTREntityAIEat(this, LOTRFoods.ROHAN, 8000));
        ((EntityLiving)this).tasks.addTask(6, (EntityAIBase)new LOTREntityAIDrink(this, LOTRFoods.ROHAN_DRINK, 8000));
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        final int i = ((Entity)this).rand.nextInt(LOTREntityRohanMan.weapons.length);
        super.npcItemsInv.setMeleeWeapon(LOTREntityRohanMan.weapons[i].copy());
    ...
    public String getNPCFormattedName(final String npcName, final String entityName) {
        if (this.getClass() == LOTREntityRohanMan.class) {
            return StatCollector.translateToLocalFormatted("entity.lotr.RohanMan.entityName", new Object[] { npcName });
        }
    ...
    protected void dropRohanItems(final boolean flag, final int i) {
