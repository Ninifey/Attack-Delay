...
public class LOTRModInfo
{
    ...
    public static final String version = "Update v35.3 for Minecraft 1.7.10";
    public static final String[] description;
    
    public static final String concatenateDescription(int startIndex) {
        String s = "";
        int i;
        for (startIndex = (i = Math.min(startIndex, LOTRModInfo.description.length - 1)); i < LOTRModInfo.description.length; ++i) {
            s = s + LOTRModInfo.description[i] + "\n\n";
        }
        return s;
    }
